...
/// <summary>
  ...
  String[] getValuesToHighLevelArray(String[] keys, LowLevelCtxAttr ctxAttr);
  ...
  String[] getValuesToLowLevelArray(String[] keys, HighLevelCtxAttr ctxAttr);
}
